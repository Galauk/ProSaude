...
//              <td><b><div style='width:20px; text-align:left' id='qtd_estoque'> </div> </b></td>
	   echo "</select>
	       ...
	       <td width=79>";
			if(pg_num_rows($exec_sel) > 0)
			{
				echo "<a href=requisicao.php?id_login=$id_login&requis=$req_codigo&final=1><img src=".$_SESSION[linkroot].$_SESSION[comum]."imgs/finalizar_on.jpg border=0></a>";
			} else {
				echo "&nbsp;";
			}
		   echo "</td>
           <td width=79>";
				echo "<a href=requisicao.php?id_login=$id_login&req_codigo=$req_codigo&link_extra=$link_extra><img src=".$_SESSION[linkroot].$_SESSION[comum]."imgs/voltar_on.gif border=0></a>";
			echo "</td>
	      </tr></form>
	     </table>
	   </fieldset>
		...
		<input type=hidden name=dataestoque value=$rowdata>
	     ...
	     <tr>
	       <td width=95><input type=image src=".$_SESSION[linkroot].$_SESSION[comum]."imgs/editar_on.jpg></td>
               <td width=79><a href=itens_requisicao.php?id_login=$id_login&req_codigo=$req_codigo&action=form_incluir_item><img src=".$_SESSION[linkroot].$_SESSION[comum]."imgs/voltar_on.gif border=0></a></td>
	      </tr></form>
	     </table>
	   </fieldset>
	  </td>
