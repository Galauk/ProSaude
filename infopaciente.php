...
echo "</table><br><br>
<font color=red size=2>Atendimento - <b>PAM</b></font>";
...
echo "<br><br><a href='list_pacientes.php?id_login=$id_login&tpbusca=n&palavra_chave=$usu_nome&acao=busca'><img src=".$_SESSION[linkroot].$_SESSION[comum]."imgs/voltar_on.gif border=0></a>&nbsp;<a href='imprimi_infopaciente.php?id_login=$id_login&tpbusca=n&usu_nome=$usu_nome&acao=busca&usu_codigo=$usu_codigo'><img src=".$_SESSION[linkroot].$_SESSION[comum]."imgs/print_on.jpg border=0></a>";
?>
