...
<input name="iduser" id="iduser" value='<?=$usr_codigo?>' type=hidden>
</form>
</body>
</html>
<?php 
if($acao=='add') {
			   $sql = pg_query("UPDATE usuarios SET idbio = '$cadatro' where usr_codigo = '$iduser'") or die (pg_last_error());
