...
<script>
    ...
    function atualizarGrid()
    {
        ...
        if(med_codigo != "")
        {
            url = "buscarVaga.php?esp_codigo="+esp_codigo+"&med_codigo="+med_codigo+"&uni_codigo="+uni_codigo;
        } else {
            url = "buscarVaga.php?esp_codigo="+esp_codigo+"&uni_codigo="+uni_codigo;
        }
    ...
    function abrirAgendar2(lie_codigo, med_codigo)
    {
        id_login = document.getElementById('id_login').value;
        url = "buscarDadosLista.php?controle=2&lie_codigo="+lie_codigo+"&id_login="+id_login+"&med_codigo="+med_codigo;
    ...
    function agendar(t)
    {
        ...
        url = "salvaLista.php?usu_codigo="+usu_codigo+"&uni_codigo="+uni_codigo+"&esp_codigo="+esp_codigo+"&med_codigo="+esp_codigo+"&med_codigo="+med_codigo+"&age_data="+age_data+"&id_login="+id_login+"&agt_codigo="+agt_codigo+"&age_hora_ini="+age_hora_ini+"&lie_codigo="+lie_codigo;
...
<?php
    ...
    echo "<fieldset>";
        ...
        echo "<div style=\"width:100%;height:335px;\" id=\"grid\"></div>";
    echo "</fieldset>";
