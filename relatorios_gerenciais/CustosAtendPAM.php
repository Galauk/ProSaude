...
$tp_custo = 1;  //Relatorio pelo Custo Medio dos produtos
$SinAna = 0;  //Relatorio pelo Custo de Referencia
...
$titulo="CUSTOS DE ATENDIMENTO DO PAM";    //       NOME DO RELATÓRIO
...
//--->        Cabeçalho do Sistema
        ...
        if ($Cab == 0) {
            echo "<table width=100% cellspacing=0 cellpadding=0 border=0 align=center opmargin=0 leftmargin=0>
	 	           <tr>
	     	        <td width=80><font size=3 face=courier>GESTAO PUBLICA DE SAUDE</font></td>
         	        <td width=10 align=right><font size=1 face=courier>".date("d/m/Y h:i:s")."</font></td>
           	        <td width=10></td>
	    	       </tr>
 	    	       <tr>
 	     	        <td colspan=3><font size=3 face=courier> $Tit </font></tdu
 	    	       </tr>
 	    	       <tr>
 	     	        <td colspan=3><font size=3 face=courier>PERIODO: $dtIni A $dtFin </font></td>
 	    	       </tr>
 	    	       <tr>
 	     	        <td colspan=3><font size=3 face=courier>USUARIO: $Pac </font></td>
 	    	       </tr>
 	    	       <tr>
 	     	        <td colspan=3><font size=3 face=courier>MEDICO: $Med </font></td>
 	    	       </tr>
 	    	       <tr>
 	     	        <td colspan=3><font size=3 face=courier>PROCEDIMENTO: $Proc </font></td>
 	    	       </tr>
 	    	       <tr>
 	     	        <td colspan=3><font size=3 face=courier>TIPO DE CUSTO: $TPCust </font></td>
 	    	       </tr>
 	    	       <tr>
 	     	        <td colspan=3><font size=3 face=courier>SINTET / ANALIT: $SinteAnali </font></td>
 	    	       </tr>
 	    	       <tr>
		            <td colspan=4>&nbsp;</td>
	    	       </tr>
 	    ...
 	    echo "<table style=\"font-size:14px;font-family:courier,vardana,arial;\" width=100% align=center cellspacing=0 cellpadding=0 border=0 topmargin=0 leftmargin=0>\n";
 	}
...
$sql  = "SELECT distinct atendimento.ate_codigo, usuario.usu_nome, medico.med_nome,
...
/*custo    MEDICAMENTO / MATERIAL                                 */
      $sql="SELECT itens_movimento.pro_codigo, produto.pro_nome, itens_movimento.ite_quantidade,
                   itens_movimento.ite_vlrunit, verifica_preco(itens_movimento.pro_codigo, set_saida, mov_data)
      ...
      while($rowMedMat=pg_fetch_row($queryMedMat)) {
            $VlrMov=$rowMedMat[2] * $rowMedMat[4];
            if ($SinAna==2) {
                echo " <tr>\n";
                echo "  <td>&nbsp;</td>\n";
                echo "  <td>".substr($rowMedMat[1],0,40)."</td>\n";
                echo "  <td align=center>".$rowMedMat[2]             ."</td>\n";
                echo "  <td width=10%>&nbsp;</td>\n";
                echo "  <td align=center>".$rowMedMat[3]             ."</td>\n";
                echo "  <td width=10%>&nbsp;</td>\n";
                echo "  <td align=center>".formata_valor($VlrMov)    ."</td>\n";
                echo "  <td width=5%>&nbsp;</td>\n";
                echo " </tr>\n";
            }
      ...
      if ($TotMedMatHosp > 0  ||  pg_num_rows($queryMedMat) > 0) {
          ...
          if ($SinAna==2) {
              echo "  <td>&nbsp;</td>\n";
              echo "  <td colspan=3 align=center><hr3 style='font-weight:bold'>TOTAL</hr3> Medicamentos/Material HOSPITALAR -&nbsp;&nbsp; </td>\n";
              echo "  <td colspan=3 align=center>".formata_valor($TotMedMatHosp)."</td>\n";
              echo "  <td width=5%>&nbsp;</td>\n";
          } else {
                  echo "  <td colspan=2 align=center><hr3 style='font-weight:bold'>TOTAL</hr3> Medicamentos/Material HOSPITALAR -&nbsp;&nbsp; </td>\n";
              echo "  <td colspan=1 align=center>".formata_valor($TotMedMatHosp)."</td>\n";
...
/*custo  PROCEDIMENTO                                             */
      ...
      while($rowProc=pg_fetch_row($queryProc)) {
            if ($SinAna==2) {
                ...
                echo "  <td align=center>".formata_valor($rowProc[1])."</td>\n";
                echo "  <td colspan=5>&nbsp;</td>\n";
                echo " </tr>\n";
            }
      ...
      if ($TotProcHosp > 0  ||  pg_num_rows($queryProc) > 0) {
          ...
          echo "  <td align=center>".formata_valor($TotProcHosp)."</td>\n";
          echo "  <td colspan=5>&nbsp;&nbsp;</td>\n";
          echo " </tr>\n";
      }
/*custo  EXAMES / DIAGNOSTICO                                     */
      ...
      while($rowExam=pg_fetch_row($queryExam)) {
            if ($SinAna==2) {
                ...
                echo "  <td align=center>".$rowExam[1] ."</td>\n";
                echo "  <td colspan=5>&nbsp;            </td>\n";
                echo " </tr>\n";
            }
      ...
      if ($TotExamHosp > 0  ||  pg_num_rows($queryExam) > 0) {
          ...
          echo "  <td align=center>".formata_valor($TotExamHosp)."</td>\n";
          echo "  <td colspan=5>&nbsp;&nbsp;</td>\n";
          echo " </tr>\n";
      }
      ...
      echo " <tr style='font-weight:bold'>\n";
      echo " <td>&nbsp;</td>\n";
      echo "  <td colspan=1 align=center>TOTAL  DO PACIENTE -&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;</td>\n";
...
echo " <tr style='font-weight:bold'>\n";
echo " <td>&nbsp;</td>\n";
echo "  <td colspan=1 align=rigth>TOTAL  DO RELATÓRIO -&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </td>\n";
