...
<script>
	jQuery(function($){
		...
		$("#list12").jqGrid({ 
			...
			url:'gera_pni.php?uni_codigo=<?=$_POST['uni_codigo'];?>&mes_ref=<?=$_POST[mes_ref]; ?>', 
			datatype: "json", 
...
<body>
	<?php
		echo $common->menuTab(array("SI-PNI"));
			echo $common->bodyTab();
				echo $form->openForm("gera_pni.php","POST","form");
					...
					echo "<br><br>".$form->inputText("mes_ref",null,"Mes/Ano de referencia",null,7,"onKeypress=\"return Ajusta_Mes(this,event)\"");
