    ...
    public function getDadosCadastroDomiciliar() {
        $sql = "SELECT DISTINCT  
                        ...
                        (SELECT tbpd.co_pergunta_detalhe || ' L' 
                         ...
                         WHERE tbdr.co_cds_cad_domiciliar=tdcdr.co_cds_cad_domiciliar AND tbdr.co_pergunta = 57)  AS situacao_moradia,
                        (SELECT tbpd.co_pergunta_detalhe || ' L'
                         FROM tb_cds_domicilio_resposta AS tbdr 
                         INNER JOIN tb_pergunta_detalhe AS tbpd ON tbdr.co_pergunta_detalhe=tbpd.co_pergunta_detalhe
                         WHERE tbdr.co_cds_cad_domiciliar=tdcdr.co_cds_cad_domiciliar AND tbdr.co_pergunta = 58)  AS localizacao
