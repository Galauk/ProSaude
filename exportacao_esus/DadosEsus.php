...
class ThriftEsus {  
    ...
    public function contaQtdRegistros(){
        ...
        $bdAteIndividual = new BancoAtendimentoIndividual(); // ok 
        $qtdAI = $bdAteIndividual->getQtdRegistros();

        $bdAtividadeColetiva = new AtividadeColetiva(); // ok
    ...
    public function geraArquivo(){
        ...
        if ($tEsus->validaRespEnvio() > 0) {
            ...
            // echo "<pre>";print_r($eeh_codigo);die();
