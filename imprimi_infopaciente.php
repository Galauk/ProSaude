...
<body onkeydown='hotkey(event)' onload='self.print();' topmargin=0 leftmargin=0>
<?
//------------------------------------------------------------------>
...
$Pac=pg_fetch_array(pg_query("select * from usuario where usu_codigo='$usu_codigo'"));
 ...
 echo "<table width=100% cellspacing=1 cellpadding=4 border=0>
	<tr><td colspan=\"6\"><strong>Paciente: $Pac[usu_codigo] $Pac[usu_nome]  - Prontuário  $Pac[usu_prontuario]</td><td><strong>IMPRESSO: ".date('d/m/Y')."</strong></td></tr>
	<tr bgcolor=CCCCCC>
