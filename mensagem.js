window.onload = function()
{
    ...
    {
        document.getElementById('tipo').onchange = atualiza_dest;
        document.getElementById('add_dest').onclick = add_dest;
        document.getElementById('add_dest_all').onclick = add_dest_all;
        document.getElementById('rem_dest').onclick = rem_dest;
        document.getElementById('rem_dest_all').onclick = rem_dest_all;
        document.getElementById('form_msg').onsubmit = form_submit;
    }
    if( document.getElementById('cx_sel_all') )
    {
        document.getElementById('cx_sel_all').onclick = cx_sel_all_click;
        document.getElementById('cx_del_sel').onclick = cx_del_sel_click;
    }
}
...
{
    var Dest = document.getElementById('dest'), Tipo = document.getElementById('tipo'), DestL = document.getElementById('dest_list');
...
{
    var Obj = eval(Str), Dest = document.getElementById('dest');
...
function add_dest()
{
    return altera_destinatario( document.getElementById('dest'), document.getElementById('dest_list') );
}
function add_dest_all()
{
    var D = document.getElementById('dest'), L = document.getElementById('dest_list'), T = document.getElementById('tipo');
    if( ! T.value ) return 0;
...
function rem_dest()
{
    return altera_destinatario( document.getElementById('dest_list'), document.getElementById('dest') );
}
...
function rem_dest_all()
{
    ...
    // soh inverti a ordem !!!
    var D = document.getElementById('dest_list'), L = document.getElementById('dest'), T = document.getElementById('tipo');
...
{
    var DestL = document.getElementById('dest_list'), Dest = document.getElementById('dest'), Tipo = document.getElementById('tipo');
