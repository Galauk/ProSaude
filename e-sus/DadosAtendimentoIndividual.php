...
class ThriftAteIndividual {
	...
	public function fichaAtendimentoIndividualChildThrift($row){
		...
		$array_atend_individual = array(
			...
			"sexo" => $row["eai_sexo"],
			//E-SUS 3.1 - FIXADO TURNO DA MANHA
			"turno" => '1'
		);
		// echo "<pre>";print_r($array_atend_individual['problemaCondicaoAvaliada']);die();
	...
	// fator de ris para doença cardiovascular
