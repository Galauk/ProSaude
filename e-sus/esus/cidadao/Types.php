...
//include_once $_SESSION[root].$_SESSION[modulo]."/e-sus/Thrift/lib/php/lib/Thrift/Base/TBase.php";
  ...
  public function __construct($vals=null) {
      ...
      self::$_TSPEC = array(
        ...
        8 => array(
          'var' => 'endereco',
          'type' => TType::STRUCT,
          'class' => '\esus\cidadao\EnderecoTransportThrift',
          ),
        9 => array(
          'var' => 'escolaridadeId',
          'type' => TType::I64,
      ...
      switch ($fid)
      {
        ...
        case 8:
          if ($ftype == TType::STRUCT) {
            $this->endereco = new \esus\cidadao\EnderecoTransportThrift();
