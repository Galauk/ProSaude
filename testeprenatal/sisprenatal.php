		...
		/*ESSE SELECT PEGA OS PRENATAIS QUE NAO FORAM INTERROMPIDOS NEM TERMINADOS.*/
			...
			$topo = $form->inputText("sispn_numero_gestacao","$sispn_numero_gestacao","Numero da Gesta&ccedil;&atilde;o",null,null,null,null,"S").
	   		...
	   		/*Fim do topo */
				...
				$vacina = "<fieldset style='width: 100px; height:165px;'>
							...
							<table width=50 border='0'>
								<tr>
									...
									<td>
										<input type='radio' name='dose' id='dose' value='1' onChange=\"marcaVacina()\" ".($primeira != "" ? "checked=checked" : "" ).">
									</td>
									<td>$primeira</td>
								</tr>
								...
								<tr>
									...
									<td>
										<input type='radio' name='dose' id='dose' value='2'onChange=\"marcaVacina()\" ".($segunda != "" ? "checked=checked" : "" ).">
									</td>
									<td>$segunda</td>
								</tr>
								<tr>
									...
									<td>
										<input type='radio' name='dose' id='dose' value='6' onChange=\"marcaVacina()\" ".($reforco != "" ? "checked=checked" : "" ).">
									</td>
									<td>$reforco</td>
								</tr>
								<tr>
									...
									<td>
										<input type='radio' name='dose' id='dose' value='9' onChange=\"marcaVacina()\" ".($imune != "" ? "checked=checked" : "" ).">
									</td>
								</tr>
						   </table>
						  </fieldset>";
