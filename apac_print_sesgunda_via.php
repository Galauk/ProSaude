...
<?php
	...
	(CASE WHEN a.pac_codigo IS NOT NULL THEN p0.usu_nome || ', ' || COALESCE(p0.usu_cpf,'000.000.000-00')
	WHEN a.pac_apac_codigo IS NOT NULL THEN p1.pac_nome || ', ' || COALESCE(p1.pac_cpf_cns,'000.000.000-00')
	...
	(CASE WHEN a.med_sol_codigo IS NOT NULL THEN m0.med_nome || ', ' || COALESCE(m0.med_cpf,'000.000.000-00')
	WHEN med_sol_apac_codigo IS NOT NULL THEN m1.med_nome || ', ' || COALESCE(m1.med_cpf,'000.000.000-00')
	...
	(CASE WHEN uni_pres_codigo IS NOT NULL THEN u4.uni_desc || ', ' || COALESCE(u4.uni_cnpj,'000.000.000-00') || ', ' || u4.uni_codigo
	WHEN uni_pres_apac_codigo IS NOT NULL THEN u5.uni_desc || ', ' || COALESCE(u5.uni_cnpj,'000.000.000-00') || ', ' || u5.uni_codigo
	ELSE 'none' END) as uni_pres_desc,

	(CASE WHEN med_aud_codigo IS NOT NULL THEN m2.med_nome || ', ' || COALESCE(m2.med_cpf,'000.000.000-00')
	WHEN med_aud_apac_codigo IS NOT NULL THEN m3.med_nome || ', ' || COALESCE(m3.med_cpf,'000.000.000-00')
	ELSE 'none' END) as med_aud_nome,

	TO_CHAR(apac_periodo_validade,'DD/MM/YYYY') as periodo_validade,
	TO_CHAR(apac_periodo_validade_fim,'DD/MM/YYYY') as periodo_validade_fim,
...
/*		$ql_proc = "SELECT a.apac_codigo, a.proc_codigo, p.proc_codigo, p.proc_nome ".
		...
		/*$ql_proc = "SELECT p.proc_codigo, p.proc_nome
					...
					WHERE p.proc_codigo IN 
					( SELECT proc_codigo FROM apac_procedimento WHERE apac_codigo = $apac_codigo ) 
					UNION
					SELECT a.proc_codigo, a.proc_nome
					FROM apac_procedimento_cad AS a
					WHERE a.proc_codigo IN 
					( SELECT proc_apac_codigo FROM apac_procedimento WHERE apac_codigo = $apac_codigo )
					ORDER BY 2 ";*/
...
?>
  <table width="750px" border="0" cellspacing="1" cellpadding="1">
    <tr>
      <td width="70%">&nbsp;</td>
      <td width="30%">
          <div align="left">&nbsp;&nbsp;<h1><? echo $res['apac_num']; ?></h1>
      </div></td>
    </tr>
    <tr>
      <td width="70%"><div align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size=2><? echo $arr1[0]; // nome do paciente ?></font></div><br /></td>
      <td width="30%"><div align="left">&nbsp;&nbsp;<font size=2><? echo $arr1[1]; // cpf do paciente ?></font></div><br /></td>
    </tr>
  </table><br />
  <table width="750px" border="0" cellspacing="1" cellpadding="1">
    <tr>
      <td width="80%"><div align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size=2><? echo $arr2[0]; // unidade solicitante nome ?></font></div><br /></td>
      <td width="20%"><div align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size=2><? echo $arr2[1]; // codigo ?></font></div><br /></td>
    </tr>
  </table><br />
  <table width="750px" border="0" cellspacing="1" cellpadding="1">
    <tr>
      <td width="35%"><div align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size=2><? echo $arr3[1]; // cpf do medico solicitante ?></font></div><br /></td>
      <td width="65%"><div align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size=2><? echo $arr3[0]; // nome do medico solicitante ?></font></div><br /></td>
    </tr>
  </table><br />
  <table width="750px" border="0" cellspacing="1" cellpadding="1">
  <?
  		...
  		while ($resp_p = pg_fetch_array($query))
		{
			...
			?>
			<tr>
				<td width="78%"><div align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size=2><? echo $resp_p[1]; ?></font></div></td>
				<td width="22%"><div align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size=2><? echo $resp_p[0]; ?></font></div></td>
			</tr>
		<?
			$i++;
		}
  ...
  <table width="750px" border="0" cellspacing="1" cellpadding="1">
    <tr>
      <td width="80%"><div align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size=2>AUTARQUIA MUNICIPAL DE SAÚDE</font></div><br /></td>
      <td width="20%"><div align="left">&nbsp;</div><br /></td>
    </tr>
  </table><br />
  <table width="750px" border="0" cellspacing="1" cellpadding="1">
    <tr>
      <td width="50%"><div align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size=2><? echo $arr4[0]; //nome unidade prest. de serv.?></div><br /></td>
      <td width="30%"><div align="left">&nbsp;&nbsp;&nbsp;<font size=2><? echo $arr4[1]; //nome unidade prest. de serv.?></div><br /></td>
      <td width="20%"><div align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size=2><? echo $arr4[2]; // unidade prest. de serv.?></div><br /></td>
    </tr>
  </table><br />
  <table width="750px" border="0" cellspacing="1" cellpadding="1">
    <tr>
      <td width="30%"><div align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size=2><? echo $res['periodo_validade']; ?> à <? echo $res['periodo_validade_fim']; ?></div></td>
      <td width="40%"><div align="left">&nbsp;&nbsp;&nbsp;&nbsp;<font size=2><? echo $arr5[1]; ?></div></td>
      <td width="30%">&nbsp;</td>
    </tr>
  </table>
</div>
