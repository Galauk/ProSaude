...
ALTER TABLE compra_produto_itens
   ADD COLUMN comp_codigo bigint NOT NULL;
ALTER TABLE compra_produto_itens ADD CONSTRAINT comp_codigo FOREIGN KEY (comp_codigo) REFERENCES compra_produto (comp_codigo) ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE compra_produto
   ADD COLUMN comp_data date;
