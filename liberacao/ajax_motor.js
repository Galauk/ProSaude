...
/** 
 * Procura por um elemento no array
 * @var Arr Array
 * @var id String id do elemento
 * @return 	bool
*/
...
function esconde_janela( id )
{
	...
	//
	C.innerHTML = 'Carregando <img src=\"imgs/loading.gif\" alt=\"Carregando\" align=\"absmiddle\" />';
}
...
function janela_carregando( id )
{
	...
	//J.innerHTML = 'Carregando <img src=\"imgs/loading.gif\" alt=\"Carregando\" align=\"absmiddle\" />';
}
// Ajax ------------------------------------------------------------------------
