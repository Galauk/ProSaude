	...
	<head>
		...
		$(function(){
			...
			$("form").submit(function(e){
				...
				window.opener.executaAcao(id, strData, unidade,resposta,para,pro_codigo,usu_codigo_prontuario);				
				window.close();	
	...
	<body>
		<form method="post">
          ...
          $queryUnidade = pg_query($sqlUnidade);
     	  $linha = pg_fetch_array($queryUnidade);
               ?>
               
            <input type='hidden' name='unidade' id='unidade' value="<?=($para == "" || $resposta == "P" ? $linha['uni_codigo'] : "");?>|">
			<div id="data"></div>
