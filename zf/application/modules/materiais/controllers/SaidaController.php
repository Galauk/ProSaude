...
class Materiais_SaidaController extends Zend_Controller_Action {

    public function init(){
        $this->view->title = "Saída";
    ...
    // action body
        ...
        $this->view->setor_origem =  $tbSet->selectTag(TRUE,NULL,$movimento[set_saida],"S");
        $this->view->setores = $tbSet->selectTag(FALSE,"set_codigo_destino",$movimento[set_entrada],"S");
    }
