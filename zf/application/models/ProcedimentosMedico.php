...
class Application_Model_ProcedimentosMedico extends Elotech_Db_Table_Abstract {

    protected $_name = 'procedimentos_medico';
	protected $_primary = 'proc_codigo';
	protected $_sequence = 'procedimentos_medico_promed_codigo_seq';
