...
require_once($_SESSION[root].$_SESSION[modulo].'html2pdf/_class/exception.class.php');
require_once($_SESSION[root].$_SESSION[modulo].'html2pdf/_class/locale.class.php');
require_once($_SESSION[root].$_SESSION[modulo].'html2pdf/_class/myPdf.class.php');
require_once($_SESSION[root].$_SESSION[modulo].'html2pdf/_class/parsingHtml.class.php');
require_once($_SESSION[root].$_SESSION[modulo].'html2pdf/_class/parsingCss.class.php');


class Application_Model_Html2Pdf extends Elotech_Db_Table_Abstract 
    {
        /**
