...
class Application_Model_UsuarioDoencas extends Elotech_Db_Table_Abstract {

    protected $_name = 'usuario_doencas';
    ...
    public function getDadosPorUsuario($usuCod=FALSE){
        $sql = $this->select(FALSE)
                    ...
                    ->from(array("usud"=>"usuario_doencas"),array("co_pergunta_detalhe"))
