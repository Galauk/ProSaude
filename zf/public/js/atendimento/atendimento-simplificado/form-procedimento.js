        ...
        $("#dadosProcAtendSimp").append(
            ...
            <div class='procAtendSimp' id='procAtendSimp`+$("#proc_codigo").val()+`'>
                ...
                <div>
                    ...
                    <input class="valorFormatado" id="valorDoProcedimento[]" onkeypress="formataValor()" name ="valorDoProcedimento[]" type="text"/>
                </div>
                <br>
            </div>`);
    }
