...
//log
reglog($id_login,"Acessando o programa dos números de AIH");
...
// 		ESQ_SAUDE, $where1, ESQ_SAUDE, $where2, $sql_f );
   ...
   $stmt = "SELECT aan_codigo, aan_numero_resto, aan_tipo from aih_apac_numeros_resto where aan_tipo='AIH' ". $AND ."". $sql_f ;
...
if( $acao == 'del' )
{
	...
	reglog($id_login,"Deletando o número de AIH");
