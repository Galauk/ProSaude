...
echo "<center>
      __________________________________________<br>
              Carimbo e Ass. do Médico $medInfo[med_nome]<br>CRM: $medInfo[med_crm]</center>";
 echo "</td>
	</tr>
       </table>
	...
	<tr>
	 <td><img src=".$_SESSION[linkroot].$_SESSION[comum]."imgs/tira_papeis.jpg width=500 height=3></td>
	    ...
	    <td align=center><b>$uniInfo[uni_desc]</b>&nbsp;&nbsp;$uniInfo[uni_localizacao]</td>
           ...
           <tr>
	    <td align=center><b>ATENÇÃO</b></td>
	   </tr>
           <tr>
	    <td align=center>Este documento não poderá ser rasurado. Deve ser entregue na sua empresa dentro de 24 horas.<br>
			     Não podendo ser concedido neste atestado afastamento superior a 15(quinze) dias, nem retroativo.
	    </td>
	   </tr>
	  </table>";
