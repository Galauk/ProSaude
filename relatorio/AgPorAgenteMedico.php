...
<script>
	...
	function abreRelatorio(di,df){
		...
		url = "AgendaPorAgenteMedico.php?di="+di+"&df="+df+"&usr_codigo="+usr_codigo+"&uni_codigo="+uni_codigo+"&tp_rel="+tp_rel;
...
echo $common->menuTab(array("Agendamentos Remarcados e Transfer�ncias"));
