...
<script>
	...
	function abreRelatorio(di,df){
		...
		url = "VacinaAprazamentoUsuario.php?di="+di+"&df="+df+"&usu_codigo="+usu_codigo+"&uni_codigo="+uni_codigo+"&tp_rel="+tp_rel;
...
<?php 
echo $common->menuTab(array("Vacinas apreasadas por Paciente"));
