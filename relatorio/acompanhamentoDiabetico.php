...
//--------------------------------------------------------------------------------------------------------------------------
 ...
 echo $common->menuTab(array('Acompanhamento de Diabeticos'));
...
echo "     <tr>\n";
	...
	echo "      <td valign='bottom' align='left'>&Aacute;rea</td>\n";
	echo "      <td> <input type='text' name='micro' id='micro' value='' class='inputForm'>   </td>\n 
			</tr>";

echo "     <tr>\n";

	echo "      <td valign='bottom' align='left'>Micro-&Aacute;rea</td>\n";
	echo "      <td> <input type='text' name='micro' id='micro' value='' class='inputForm'>   </td>\n 
			</tr>";
			
echo "     <tr>\n";

echo "      <td valign='bottom' align='left'>Nome Usu&aacute;rio:</td>\n";
echo "      <td> <input type='text' name='micro' id='micro' value='' class='inputForm' size='50'>   </td>\n 
			</tr>";
			
			
		echo "<tr>
				 <td colspan='2'><span style='cursor:pointer' <img  src=".$_SESSION[linkroot].$_SESSION[comum]."imgs/gerar_relatorio_on.jpg OnClick='CheckCall()'  name='enviar' value='ENVIAR'> </td>\n";
		echo " </tr>\n";
echo "    </table>\n";
