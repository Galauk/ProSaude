...
<script>
	...
	function abreRelatorio(di,df){
		...
		url = "FaltososPorPeriodoPorMedico.php?di="+di+"&df="+df+"&usr_codigo="+usr_codigo+"&uni_codigo="+uni_codigo+"&tp_rel="+tp_rel;
...
echo $common->menuTab(array("Relatório de Médicos faltosos Por Período"));
