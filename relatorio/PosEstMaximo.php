...
function VerData() {
  ...
  window.open('PosicaoEstMaximo.php?dt_inicial=' + dtInicial   +
                                        '&dt_final=' + dtFinal     +
                                      '&set_codigo=' + codSetor    +
                                      '&gru_codigo=' + codGrupo
                                      , null
...
echo "  <fieldset>";
echo "   <legend>Produtos que atingiram o Estoque Maximo</legend> \n";

echo "    <table style=\"width:85%;margin-left:70px;margin-right:0px;\" border='0'  cellspacing='1' cellpadding='1'>\n";
echo "     <tr>\n";
echo "      <td><input class='box' type='hidden' name='dt_inicial' size='12' value='01-01-1901'/></td>\n";
echo "     </tr>\n";
echo "     <tr>\n";
echo "      <td valign='middle'>Data</td>\n";
echo "      <td><input type='text' class='box' name='dt_fim' size='12' value='$data' onKeypress='return Ajusta_Data(this, event);'></td>\n";
echo "     </tr>\n";
echo "     <tr>\n";
echo "      <td valign='middle'>Grupo de Produto</td>\n";
