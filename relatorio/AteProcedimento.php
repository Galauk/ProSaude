...
<script>
	...
	function abreRelatorio(di,df){
		...
		url = "AtendimentoProcedimento.php?di="+di+"&df="+df+"&proc_codigo="+proc_codigo+"&uni_codigo="+uni_codigo+"&tp_rel="+tp_rel;
...
<?php 
echo $common->menuTab(array("Procedimentos Realizados"));
echo $common->bodyTab("1");
	echo $form->openForm("$PHP_SELF","POST","");
		...
		echo $form->inputText("proc_nome",$esp_nome,"Procedimento",50);
