...
<script>
	...
	function abreRelatorio(di,df){
		var ordem = $("input[name=ordem]:checked").val();
		var uni_codigo = $("#uni_codigo").val();
		url = "EscalaPlantoesDetalhes.php?di="+di+"&df="+df+"&uni_codigo="+uni_codigo+"&ordem="+ordem;
...
echo $common->menuTab(array("Escala de Plant&otilde;es"));
echo $common->bodyTab("1");
	echo $form->openForm("$PHP_SELF","POST","");
		...
		echo $form->inputCheckboxRadio("ordem",null,"Ordena&ccedil;&atilde;o",null,$arrayOrdenacao,"radio");
