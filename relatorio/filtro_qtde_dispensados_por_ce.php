...
function Emite_relatorio() {
	...
	parent.open("total_medicamentos_dispensados_ce.php?estocador="+estocador+"&data_ini="+data_ini+"&data_fim="+data_fim+"&pro_cod="+pro_cod,null,"height=400,width=750,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes");
	return true;
}
...
<body>
<fieldset>
<legend>Total de medicamentos dispensados por centro estocador</legend>
