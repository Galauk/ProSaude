...
<body>
<fieldset>
<legend>Total de Atendimentos por Profissional</legend>
<form method="post" action="relatorio/rel_totalAtendimentoTotais.php" target='_blank'>
	<table>
		
       
		<tr>
			<td width='30' align=right>Unidade: </td>
			<td><select name="uni_codigo" id="centro_estocador" class="box">
				...
				?>
				<option value="<?=$row[uni_codigo]?>"><?=$row[uni_nome]?></option>
				<?
						}
					}
				?>
