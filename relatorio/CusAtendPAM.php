...
function pacientes(nome,codigo,nascimento,mae,cidade) {
   document.frm_CusAtendPAM.pac_codigo.value = nome;
   document.frm_CusAtendPAM.pac_nome.value = codigo;
...
function VerData() {
   ...
   gdtInicial =document.frm_CusAtendPAM.dt_inicial.value;
   gdtFinal   =document.frm_CusAtendPAM.dt_final.value;
   gPaciente  =document.frm_CusAtendPAM.pac_codigo.value;
   gMedico    =document.frm_CusAtendPAM.med_codigo.value;
   gProced    =document.frm_CusAtendPAM.proc_codigo.value;
   gTipoCusto =document.frm_CusAtendPAM.TPCusto.value;
   gSinteAnali=document.frm_CusAtendPAM.SinAna.value;

   if (gdtInicial == '') {
       alert("Periodo INVALIDO");
       document.frm_CusAtendPAM.dt_inicial.focus();
       return false;
   }
   if (gdtFinal == '') {
       gdtFinal = gdtInicial;
   ...
   window.open('CustosAtendPAM.php?dt_inicial='+gdtInicial  +
                                   '&dt_final='+gdtFinal    +
...
echo " <form name='frm_CusAtendPAM' method='post' action='$PHP_SELF'>\n";
echo "  <fieldset>\n";
...
echo "	  <tr>\n";
echo "	   <td>Sintét/Analit</td>\n";
echo "     <td>\n";
echo "      <select name='SinAna' value ='$SinAna'>\n";
echo "        <option value='1'> Sintético </option>\n";
echo "		  <option value='2'> Analítico </option>\n";
echo "      </select>\n";
echo "     </td>\n";
echo "	   <td>&nbsp;</td>\n";
echo "     <td>&nbsp;</td>\n";
