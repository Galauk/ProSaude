...
//  }
  ...
  window.open('MovimentPeriodLocalEstoq2.php?dt_inicial='+dtInicial+'&dt_final='+dtFinal+'&set_codigo='+codSetor+'&pro_codigo='+codProduto,null,"height=400,width=750,status=yes,toolbar=no,menubar=no,resizable=yes, location=no,scrollbars=yes");
}
</script>
