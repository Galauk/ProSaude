...
$(function(){
	...
	function abreRelatorio(di,df){
		...
		var usr_codigo = $("#usu_codigo").val();
		var uni_codigo = $("#uni_codigo").val();
		url = "AgendaPorPacienteFaltosos.php?di="+di+"&df="+df+"&usu_codigo="+usu_codigo+"&uni_codigo="+uni_codigo+"&tp_rel="+tp_rel;
...
echo $common->menuTab(array("Pacientes Faltosos"));
