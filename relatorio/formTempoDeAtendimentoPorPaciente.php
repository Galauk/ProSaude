...
<script>
	...
	function abreRelatorio(di,df){
		var tp_rel = $("#tp_rel").val();
		var uni_codigo = $("#uni_codigo").val();
		url = "tempoDeAtendimentoPorPaciente.php?di="+di+"&df="+df+"&uni_codigo="+uni_codigo+"&tp_rel="+tp_rel;
...
echo $common->bodyTab("1");
	...
	echo "<input type=hidden name=tp_rel id=tp_rel value=1>";
