<?php
/** MEXENDO
 * @version Eduardo (dudu@g1ti.com.br) 2007-07-06 BRT 17:39:58
 * @version Marcos Claudio Ramos 25/06/2007 10:00
...
$stmt =
		"SELECT 
			...
			medico,
			proc_codigo,
			substr(proc_nome,1,255) as proc_nome,
			cid_codigo,
			cid_nome
		FROM
		(
	...
	if( $cid_nome_ant != $linha['cid_nome'] )
	{
		...
		echo "
			...
			<tr>
				...
				<th width='10%'>C&oacute;d.</td>
				<th width='30%'>Procedimento</td>
				<th width='15%'>Munic&iacute;pio</th>
