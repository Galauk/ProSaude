...
<script>
	...
	function abreRelatorio(di,df){
		...
		url = "TotProcGeral_Gera.php?di="+di+"&df="+df+"&uni_codigo="+uni_codigo+"&tp_rel="+tp_rel;
...
echo $common->menuTab(array("Procedimentos Profissionais por Unidade"));
echo $common->bodyTab("1");
	echo $form->openForm("$PHP_SELF","POST","");
		...
		//echo $form->inputCheckboxRadio("tp_rel",null,"Tipos de Relat&oacute;rios",null,$arrayTipoRelatorio2,"radio");
