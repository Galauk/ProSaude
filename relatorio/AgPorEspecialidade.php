...
<script>
	...
	function abreRelatorio(di,df){
		...
		url = "AgendaPorEspecialidade.php?di="+di+"&df="+df+"&esp_codigo="+esp_codigo+"&uni_codigo="+uni_codigo+"&tp_rel="+tp_rel;
...
<?php 
echo $common->menuTab(array("Agenda por Especialidade"));
echo $common->bodyTab("1");
	echo $form->openForm("$PHP_SELF","POST","relEspecialidade");
		...
		echo $form->inputCheckboxRadio("tp_rel", null, "Tipo de Relatorio", null, array("0"=>"Sintetico", "1"=>"Analitico", "2"=>"Por Idade"), "radio");
		echo "<br><br><br><div style='clear:both; width:400px; border:solid 0px;'>";
				echo"<div style='float:right; width:206px;'>";		
