...
<script>
	...
	function abreRelatorio(di,df){
		...
		url = "relQuantidadePorUnidade.php?di="+di+"&df="+df+"&uni_codigo="+uni_codigo+"&tp_rel="+tp_rel;
...
echo $common->menuTab(array("Quantidade de hiperdia por unidade"));
echo $common->bodyTab("1");
	echo $form->openForm("$PHP_SELF","POST","");
		...
		echo $form->inputCheckboxRadio("tp_rel", null, "Tipo de Relatorio", null, $arrayTipoRelatorioHiper, "radio");
