...
function CheckCall() {
   ...
   gUnidade  =document.frm_RelQtExPorLaboratorio.unidade.value
...
// alterar o formulario
 // window.open('RelQtExAgendados.php?dt_inicial='+gdtInicial+'&dt_final='+gdtFinal+'&med_codigo='+gMedico+'&proc_codigo='+gProc+'&TipRel='+gTipoRel+'&SinAnal='+gSinAnal,null,"height=400,width=750,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes");
  window.open('relatorio/relexame.php?dt_inicial='+gdtInicial+'&dt_final='+gdtFinal+'&uni_codigo='+gUnidade+'&proc_codigo='+gProc+'&TipRel='+gTipoRel+'&SinAnal='+gSinAnal,null,"height=400,width=750,status=yes,toolbar=no,menubar=no,location=no,scrollbars=yes");
}
...
echo "      <td><select class='box' name='unidade'>";
echo '        <option value=""></option>';
while($uni = pg_fetch_assoc($queryUnidade)){
...
echo "     <tr>\n"; */
echo "      <td>&nbsp;</td>";
echo "        <td><a href='../rel_index.php?opcao=5#tabs-9'><img src='".$_SESSION[linkroot].$_SESSION[comum]."imgs/voltar_on.gif' border='0'></a>
