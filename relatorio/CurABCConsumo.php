...
function CheckCall() {
   ...
   gdtInicial = document.frm_CurABCConsumo.dt_inicial.value
   gdtFinal   = document.frm_CurABCConsumo.dt_final.value
   gCE        = document.frm_CurABCConsumo.CE_codigo.value
   gSetor     = document.frm_CurABCConsumo.set_codigo.value
   ...
   if (gdtFinal == '') {
       gdtFinal=document.frm_CurABCConsumo.dt_final.value=document.frm_CurABCConsumo.dt_inicial.value
   }
   var d1=gdtInicial
   var d2=gdtFinal
   for (var i = 0; i < d1.length; i++) {
   ...
   window.open('CurvaABCConsumo.php?dt_inicial=' + gdtInicial +
                                    '&dt_final=' + gdtFinal   +
					               '&CE_codigo=' + gCE        +
					              '&set_codigo=' + gSetor     +
					              '&gru_codigo=' + gGrupo     +
...
echo "  <fieldset>";
echo "   <legend>Curva ABC de Consumo</legend> \n";
