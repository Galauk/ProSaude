...
function Emite_relatorio() {
	...
	if(data_ini == ""){
		alert('O campo data Inical est� vazia!')
...
<body>
<fieldset>
<legend>Livro de Registro Especifico</legend>
<form method="post" action="relatorio/rel_LivroPsico.php" target='_blank'>
	<table>
		
       
		<tr>
			<td width='30' align=right>Centro Estocador: </td>
			<td><select name="set_codigo" id="centro_estocador" class="box">
		...
		<tr>
			<td align='right'>Livro 1:</td>
			<td><input type=radio value=1 name='livro' checked>LISTAS A1 e A2</td>
		</tr>
		
		<tr>
			<td align='right'>Livro 2:</td>
			<td><input type=radio value=2 name=livro>LISTAS A3,B1 e B2</td>
		</tr>

		<tr>
			<td align='right'>Livro 3:</td>
			<td><input type=radio value=3 name=livro>LISTAS C</td>
		</tr>

		<tr>
			<td align='right'>Livro 3:</td>
			<td><input type=radio value=4 name=livro>ANTIBIOTICOS</td>
		</tr>
