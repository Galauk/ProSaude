...
*/
   window.open('AtendimPAM_sint.php?dt_inicial=' + gdtInicial +
                               '&dt_final=' + gdtFinal   +
...
echo "     <tr>\n";
echo "      <td valign='bottom' width=15% align=right> Inicio </td>\n";
echo "      <td valign='bottom' width= 8% align=right> Data </td>\n";
...
echo "      <td width=20%> &nbsp; </td>\n";
echo "      <td valign='bottom' width=15% align=right> Hora </td>\n";
echo "      <td><input class='box' type='text' name='hr_inicial' size='5' value='$hr_inicial'/></td>\n";
echo "      <td width=15%>&nbsp;</td>\n";
echo "      <td width=15%>&nbsp;</td>\n";
echo "     </tr>\n";
echo "     <tr>\n";
echo "      <td valign='bottom' align=right> Fim&nbsp;&nbsp; </td>\n";
echo "      <td valign='bottom' align=right> Data </td>\n";
...
echo "      <td> &nbsp; </td>\n";
echo "      <td valign='bottom' align=right> Hora </td>\n";
echo "      <td><input class='box' type='text' name='hr_final' size='5' value='$hr_final'/></td>\n";
echo "      <td> &nbsp; </td>\n";
echo "      <td> &nbsp; </td>\n";
echo "     </tr>\n";
