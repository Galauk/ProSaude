...
<script>
	...
	function validaDados(){
		...
		var ano = $("#ano").val();
		url = "AtendimentoUnidadeMensal.php?ano="+ano+"&usr_codigo="+usr_codigo+"&uni_codigo="+uni_codigo+"&tp_rel="+tp_rel;
...
echo $common->menuTab(array("Quantidade por Atendimentos Geral Mensal por Unidade"));
echo $common->bodyTab("1");
	echo $form->openForm("$PHP_SELF","POST","");
		...
		$arrayTipo = array("--- TODOS ---","Janeiro","Fevereiro","Marco","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro");
		$arrayTipoRelatorio = array('Consolidado','Sintetico');

		echo $form->inputSelect("uni_codigo",null,"Unidade",$sqlUnidade,null,null,null,null,"TODOS");
		echo $form->inputSelect("ano",$arrayTipo,"Mes",null,null,null,null,null,"TODOS");
