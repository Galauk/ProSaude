...
<script>
	...
	function CheckCall()
	{
		...
		window.open('ConsumoSemestral_list.php?set_codigo='+gArmazem+'&gru_codigo='+gGrupo+'&dt_final='+gData_f+'&dt_inicial='+gData_i+'&pro_codigo='+gProduto+'&meses='+meses+'&tipomovim='+gTipo,
