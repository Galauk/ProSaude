<?php
$db = pg_connect("host=localhost dbname=db_nsgracas user=postgres password=DbManIbi2017");
...
$sql = pg_query("select to_char(usu_datanasc,'DD/MM/YYYY') as data,*from usuario where usu_codigo = '$_REQUEST[usu_codigo]'") or die(pg_last_error());
$rr = pg_fetch_array($sql);


$pad = str_pad($rr[usu_codigo], '19', '0', STR_PAD_LEFT);
new barCodeGenrator($pad,1,'cod.gif', 190, 130, true); 
