<?php
    ...
    //  echo "host=$host dbname=$banco user=$usuario port=$porta password=$senha";
    
    $db = pg_connect("host=$host port=$porta dbname=$banco user=$usuario password=$senha") or die(pg_last_error());
