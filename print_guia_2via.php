...
<td><font size=3 face='courier'>&nbsp;<?=$cid[cid_nome]?></font></td>
</tr>
</table>
<table width=100% cellspacing=0 cellpadding=0 border=0>
<tr>
...
<tr>
 <td width=74%>&nbsp;</td>
 <td><iframe name=codigo src='codigo.php?id_login=<?=$id_login?>&age_codigo=<?=$age_codigo?>' frameborder=no marginheight=0 marginwidth=0 scrolling=yes width=150 height=70></iframe>
</tr>
</table>
-->
