...
{	
	if(txt == 1)
	{
		...
		mes = document.getElementById('mes').value;	
		var endereco = "../lib/baixarArquivo.php?arquivo=../exportacao/arquivos/ssa2.txt";
...
//echo $form->openForm("exportaBPA.php", "GET");
	...
	echo $form->inputSelect("cnes", null, "ACS", $selecionaCNES, null, null, null, "style=width:262px;");
