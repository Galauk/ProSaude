...
$tipo_logradouro_fam  = $_GET['tipo_logradouro_fam'];
	...
	$stmt = "UPDATE psf SET 
					...
					tipo_casa_fam = '$tipo_casa_fam', 
					destino_lixo_fam = '$destino_lixo_fam', 
					tratamento_agua_fam = '$tratamento_agua_fam', 
					abastecimento_agua_fam = '$abastecimento_agua_fam', 
					destino_fezes_fam = '$destino_fezes_fam', 
					plano_fam = '$plano_fam', 
					plano_nome_fam = '$plano_nome_fam', 
					procura_unidade_fam = '$procura_unidade_fam', 
					comunicacao_meios_fam = '$comunicacao_meios_fam', 
					grupo_fam = '$grupo_fam', 
					transporte_meios_fam = '$transporte_meios_fam', 
					tipo_forro_fam = '$tipo_forro_fam', 
					tipo_cobertura_fam = '$tipo_cobertura_fam', 
					tipo_piso_fam = '$tipo_piso_fam', 
					renda_fam = '$renda_fam', 
					animais_fam = '$animais_fam', 
					qnt_animais_fam = '$qnt_animais_fam', 
					cond_criacao_fam = '$cond_criacao_fam',  
					qnt_comodos_fam = '$qnt_comodos_fam', 
					conservacao_dom_fam = '$conservacao_dom_fam', 
					energia_fam = '$energia_fam', 
					bolsa_fam = '$bolsa_fam' 
