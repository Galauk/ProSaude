...
<? /*echo"<table>";
		echo "<tr>";
		   echo "<td align=right width=30>Motorista:</td>";
		   echo "<td>";
			   			echo"<input type=text name='mototista'class=boxl size=30 >";
			 	    	echo"<a href='#'<img src=".$_SESSION[linkroot].$_SESSION[comum]."imgs/localizar.jpg border=0></a>";
			  		 "</td>";
			echo "<td align=right>Origem:</td>
				  <td><input type=text name=origem class=boxl size=20></td>";
		
			echo "<td align=right>Hora Saida:</td>
				  <td><input type=text name=horaSaida class=boxl size=20></td>";
			echo "<td align=right>Paciente:</td>
				  <td>
				  <input type=text name=paciente class=boxl size=20>";
			 echo"<a href='#'<img src=".$_SESSION[linkroot].$_SESSION[comum]."imgs/localizar.jpg border=0></a>";
			 echo"</td>";
	echo"</tr>";
	echo"<tr>";
			echo "<td width=40>Nro Carro:</td>";
            	echo"<td>";
            		echo"<input type=text name='numeroCarro'class=boxl size=30 >";
                echo"<a href='#'<img src=".$_SESSION[linkroot].$_SESSION[comum]."imgs/localizar.jpg border=0></a>";;
				echo "</td>";	
				
				   echo "<td align=right>Destino:</td>
				  <td><input type=text name=destino class=boxl size=20></td>";
				  
				  	 echo "<td align=right>Hora Chegada:</td>
				  <td><input type=text name=horaChegada class=boxl size=20></td>";
...
?>
<!--<table cellpadding='4' class="tabvacina">
	<tr>
	...
	<tr>
		<td>
			<div class="global-div">
				<ul class='abas'>
					<li><a href="#noticia1">Nome</a></li>
					<li><a href="#noticia2">Gerais</a></li>
					<li><a href="#noticia3">Dados</a></li>
				</ul>
	...
	<tr>
		...
		<? /*
			...
			echo"</tr>";
				...
				/*echo "<td align=right>Paciente:</td>
					  <td>
					  <input type=text name=paciente size=20>";
				 echo"<a href='#'<img src=".$_SESSION[linkroot].$_SESSION[comum]."imgs/localizar.jpg border=0></a>";
				 echo"</td>";
			echo"</tr>";
			echo"<tr>";	  
			...
			echo"<tr>";	  
				echo "<td align=right width=100>Quantidade:</td>
					<td><input type=text name=quantCombustivel size=20></td>";
			echo"</tr>";
