...
require_once $_SESSION[linkroot].$_SESSION[comum]."library/php/funcoes.inc.php";
...
<fieldset>
	 ...
	 <td><input type=text name=cad_datapedido value='<?=$sel[cad_datapedido]?>' size=12 class=box onkeypress='Ajusta_Data(this, event);' maxlength=10></td>
	</tr>
        <tr>
	 <td align=right>Data Previsao Entrega:</td>
	 <td><input type=text name=cad_previsaoentrega value='<?=$sel[cad_previsaoentrega]?>' size=12 class=box onkeypress='Ajusta_Data(this, event);' maxlength=10></td>
	</tr>
        <tr>
	 ...
	 <?
	$sql = pg_query("select *from medico where prestador_servico='S'");
...
echo "<tr>
       <td>&nbsp;</td>
       <td><a href=exa_listapedidoexame.php><img src=".$_SESSION[linkroot].$_SESSION[comum]."imgs/voltar_on.gif border=0></a>&nbsp;<input type=image src=".$_SESSION[linkroot].$_SESSION[comum]."imgs/enviar_on.jpg class=boxx></td>
      </tr>";
} else {
echo "<tr>
       <td>&nbsp;</td>
       <td><a href=exa_listapedidoexame.php><img src=".$_SESSION[linkroot].$_SESSION[comum]."imgs/voltar.png border=0></a>&nbsp;<a href=$PHP_SELF?acao=finaliza><img src=".$_SESSION[linkroot].$_SESSION[comum]."imgs/finalizar_pedido_on.png border=0></a></td>
      </tr>";
}
?>
	</form>
...
$sql = pg_query($stmt);
        echo "<SCRIPT LANGUAGE=\"JavaScript\">
                  setTimeout(\"location='exa_pedidoexame.php?acao=form_edit&id_login=$id_login&cad_exame=$cad_exame&labm_codigo=$labm_codigo'\", 0);
              </SCRIPT>";
