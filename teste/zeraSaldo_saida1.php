<?php
include "../global.php";
$sqlSetor = "select distinct set_codigo from saldo where set_codigo = 86 ";
...
while($reg_setor = pg_fetch_array($querySetor)){
	...
	$insert = "insert into movimento(mov_codigo,mov_data,mov_tipo,mov_saida,mov_observacao,set_saida) VALUES ($mov_codigo,now(),'S','S','Colocando saídas para ajustar balanço',$reg_setor[set_codigo]);";
	//echo $insert."<br/>";
