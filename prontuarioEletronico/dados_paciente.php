...
echo $form->openForm("prontuario.php?pagina=13&acao=edit&id_login=$id_login&age_codigo=$age_codigo&usu_codigo=$usu_codigo&uni_codigo=$uni_codigo&med_codigo=$med_codigo&esp_codigo=$esp_codigo&age_data=$age_data",'POST');
	echo"<table border ='0'>
			<tr><br>
	...
	echo $form->inputSelect('uni_nullPro', $unidades,'Unidade (Prontuario)',null);
	echo $form->inputText('usu_prontuario',$row[usu_prontuario],'Prontu&aacute;rio','30');
	echo $form->inputSelect('usu_sexo', $sexo,'Sexo',null);
...
echo $common->modalMsg("OK", "Editado Com Sucesso","prontuario.php?pagina=99&&id_login=$id_login&age_codigo=$age_codigo&usu_codigo=$usu_codigo&uni_codigo=$uni_codigo&med_codigo=$med_codigo&esp_codigo=$esp_codigo&age_data=$age_data");
   /*       echo "<br><br><br><br><br><br><br><br><br>
        ...
        echo "<SCRIPT LANGUAGE=\"JavaScript\">
                  setTimeout(\"location='dados_paciente.php?id_login=$id_login&age_codigo=$age_codigo&usu_codigo=$usu_codigo&uni_codigo=$uni_codigo&med_codigo=$med_codigo&esp_codigo=$esp_codigo&age_data=$age_data\", 2000);
              </SCRIPT>";
*/
}
